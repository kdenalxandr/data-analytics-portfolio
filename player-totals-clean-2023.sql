--Creating a table that counts how many players show up on more than one team
...
--Joining keeping the total stats 2TM row and ordering the table by player rank
SELECT a.*
